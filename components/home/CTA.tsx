  ...
  return (
    <div className="pt-36 relative w-full">
      ...
      <div className="pt-14 pb-40">
        ...
        <a
          href="mailto:loicnondah@gmail.com"
          className="cursor-pointer font-bold whitespace-nowrap 
        mt-6 px-8 py-3 text-white border-2 rounded-full border-white bg-black hover:bg-fun-pink hover:border-fun-pink transition-colors"
        >
          Get in Touch
        </a>
      </div>
